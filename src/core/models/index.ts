...
export interface Action { id: string; risk_id?: string; related_risk_ids?: string[]; title: string; type: 'Technique'|'Organisationnelle'|'Humaine'|'EPI'; impact: any; difficulty: 'Faible'|'Moyenne'|'Élevée'; cost: 'Faible'|'Moyen'|'Élevé'; references?: string[]; }
